...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/style/authority/jquery.fancybox-1.3.4.css" media="screen">
  ...
  <div id="container">
    ...
    <div class="ui_content">
      ...
      <table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
        ...
        <tr align="left">
          <th colspan="5">文件历史记录</th>
          </td >
        <tr>
          <td width="17%" style="font-weight:bold">上传时间</td>
          <td width="36%" style="font-weight:bold">文件名 </td>
          <td width="16%" style="font-weight:bold">指标类型</td>
          <td width="16%" style="font-weight:bold">指标名称</td>
          <td width="15%" style="font-weight:bold">操作</td>
        </tr>
        <tr>
          <td>2015-12-22 09:20:19</td>
          <td>地下水——151210——151216.xlsx</td>
          <td>水生态</td>
          <td>地下水</td>
          <td width="15%">  <input type="button" value="删除" class="ui_input_btn03" onClick="search();" /> </td>
        </tr>
